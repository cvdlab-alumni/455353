...
var manopola1 =  T([0,1,2])([0.8,0.9,0.6])(COLOR([0])(TORUS_SURFACE([0.08, 0.08])([10,10])))
var manopola2 =  T([0,1,2])([0.8,1.6,0.6])(COLOR([0])(TORUS_SURFACE([0.08, 0.08])([10,10])))
var manopola3 =  T([0,1,2])([1.3,1.1,0.6])(COLOR([0])(TORUS_SURFACE([0.08, 0.08])([10,10])))
var manopola4 =  T([0,1,2])([1.3,1.8,0.6])(COLOR([0])(TORUS_SURFACE([0.08, 0.08])([10,10])))
var bodycompleto = STRUCT([body,manopola1,manopola2,manopola3,manopola4])
...
//Chiavi di violino
var v1 =  CUBIC_HERMITE(S0)([[-0.08,0,0.3],[0.08,0,0.3],[0,0.1,0],[0,-0.1,0]])
var v2 =  CUBIC_HERMITE(S0)([[-0.08,0,0.3],[0.08,0,0.3],[0,-0.1,0],[0,0.1,0]])
var violinoSuperiore = BEZIER(S1)([v1,v2]);
var violinoSolido = BEZIER(S2)([violinoSuperiore,[0.03,0,0]])
var chiaveViolino = MAP(violinoSolido)(domain3);

var chiaveViolino1 = T([0,1,2])([0.2,4.9,-0.05])(R([0,2])(PI/2)(chiaveViolino))
var chiaveViolino2 = T([0,1,2])([0.2,5.07,-0.061])(R([2,0])(PI/2)((R([1,0])(PI/2)(chiaveViolino))))
var chiaveViolino3 = T([1,2])([0.2,-0.05])(chiaveViolino2)

var chiaviTotDX = STRUCT([chiaveViolino1,chiaveViolino2,chiaveViolino3]);

var chiaveViolino1S = T([0,1,2])([-0.2,4.9,-0.05])(R([0,2])(-PI/2)(chiaveViolino))
var chiaveViolino2S = T([1,2])([0.17,-0.011])(chiaveViolino1S)
var chiaveViolino3S = T([1,2])([0.2,-0.05])(chiaveViolino2S)
var chiaviTotSX = STRUCT([chiaveViolino1S,chiaveViolino2S,chiaveViolino3S]);
...
var corpo = T([1])([4.4])(STRUCT([manico1,frets,palettacompleta,chiaviTotDX,chiaviTotSX]))
...
var scmodel = STRUCT([bodycompleto,humbucker,humbucker2,ponte,corpo,cvd,lab,muta]);
